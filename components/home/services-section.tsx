          ...
          filteredServices.map((service) => {
            ...
            return (
              <Link
                ...
                className="flex min-h-[85px] w-full flex-col items-center text-center gap-2 rounded-2xl border border-border bg-card p-3 shadow-sm md:min-h-[70px] md:flex-row md:items-center md:text-left"
              >
