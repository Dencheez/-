                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-6 md:p-8 bg-blue-600 text-white rounded-3xl">
                            ...
                            <div className="flex gap-4">
                                <Link href="https://www.facebook.com/AqordaResmi/?ref=embed_page#" className="flex-1 flex flex-col items-center gap-2 p-3 bg-blue-700 rounded-2xl border border-white/10">
