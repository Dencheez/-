...
import { Download, ChevronLeft, Archive, BookText, Calendar } from "lucide-react"
            ...
            <div className="flex flex-col w-full bg-[#f8fafd] min-h-screen">
                ...
                <div className="max-w-5xl w-full mx-auto px-6 py-12">
                    <div className="bg-white p-12 rounded-[3rem] border border-slate-100 shadow-sm text-center">
                        <div className="bg-teal-50 w-20 h-20 rounded-[2rem] flex items-center justify-center text-teal-600 mx-auto mb-8">
                            <BookText className="w-10 h-10" />
                        </div>
                        <h2 className="text-2xl font-black text-slate-800 uppercase tracking-tighter mb-4">Архив наполняется</h2>
                        <p className="text-slate-400 text-sm font-medium max-w-md mx-auto leading-relaxed mb-10">
                            В данный момент мы проводим оцифровку выпусков журнала для публикации в открытом доступе. Пожалуйста, загляните позже.
                        </p>
                        <div className="flex items-center justify-center gap-4 text-[10px] font-black uppercase tracking-widest text-slate-300">
                            <Calendar className="w-4 h-4" />
                            <span>Ожидаемое обновление: 2024</span>
                        </div>
                    </div>
                </div>
            </div>
