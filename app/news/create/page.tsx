...
import { createPostAction } from "@/app/admin/actions" // Проверь, что в actions.ts функция называется именно так
    ...
    return (
        <AppShell>
            <div className="max-w-4xl mx-auto px-6 py-20">
                ...
                {/* Основной контент */}
                <textarea
                    placeholder="Начните писать здесь вашу статью..."
